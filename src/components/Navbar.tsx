...
export default function Navbar() {
  ...
  return <header className="relative z-30 border-b border-zinc-800 bg-[#0a0a0a]">
    <div className="border-b border-luxury-gold/15 bg-[#15130e] px-4 py-2.5 text-center text-[9px] tracking-[0.22em] text-[#d8c58d]">FREE SHIPPING ON ORDERS OVER ৳{formatBDT(150)} BDT</div>
