...
export default function ProductGrid({
  ...
  return (
    <section
      id={id}
      aria-label={title}
      className="mx-auto max-w-7xl px-6 py-16 sm:px-10 lg:px-12 lg:py-20"
    >
      <FadeIn className="mb-9 flex items-end justify-between gap-4">
        <div>
          <p className="mb-3 text-[10px] tracking-[0.3em] text-luxury-gold">
            CURATED BY ONTIVA
          </p>
          <h2 className="font-serif text-2xl tracking-[0.08em] sm:text-3xl">
            {title}
          </h2>
